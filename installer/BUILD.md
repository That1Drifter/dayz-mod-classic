...
Output: `Output\DayZModClassic-Client-1.0.0-Setup-v2.exe` (~200 MB).
...
- Compute SHA-256: `Get-FileHash Output\DayZModClassic-Client-1.0.0-Setup-v2.exe -Algorithm SHA256`
